...
public class APIRunTask extends RecursiveAction{
	...
	APIRunTask(String browserName, String testSuite){
		this.browserName = browserName;
		this.testSuite = testSuite;
	}

	APIRunTask(String path, String browserName, String testSuite){
		this.path = path;
		this.browserName = browserName;
		this.testSuite = testSuite;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		APIRunTask task =new APIRunTask();
...
/*
		...
		Thread.sleep(5000);
		try {
			task.executeCollegeSearchLocal(numberOfProcessors);
		}
		catch(Exception e) {
			System.err.println("exception is "+e.getClass().getName()+" and message is "+e.getMessage());
		}
...
*/
	...
	public void executeAapTestsPool(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "aapSuite1");
...
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "aapSuite2");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "aapSuite2");
...
//		RunTaskTemp embedTask1 = new RunTaskTemp(winchromePath,"winchrome", "embedSuite");
		APIRunTask embedTask2 = new APIRunTask(firefoxPath, "firefox", "embedSuite");
...
//		embedTask5.join();
	...
	public void executeExperience360TestsPool(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "exp360Suite");
...
//		task5.join();
	...
	public void executeIWCCFormerSuperContentTestsPool(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "iwcFormerSuperContentSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "iwcFormerSuperContentSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "iwcFormerSuperContentSuite");
...
//		task5.join();
	...
	public void executeSuperContentTestsPool(int number) {
		...
		APIRunTask superContentTask1 = new APIRunTask(localPath,"localchrome", "supercontentSuite");
//		RunTaskTemp superContentTask1 = new RunTaskTemp(winchromePath,"winchrome", "supercontentSuite");
		APIRunTask superContentTask2 = new APIRunTask(firefoxPath, "firefox", "supercontentSuite");
...
//		superContentTask5.join();
	...
	public void executeDeskTopCIFTestsPool1(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "a1DesktopCIFSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "a1DesktopCIFSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "a1DesktopCIFSuite");
...
//		task5.join();
	...
	public void executeDeskTopCIFTestsPool2(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "b2DesktopCIFSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "b2DesktopCIFSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "b2DesktopCIFSuite");
...
//		task5.join();
	...
	public void executeDeskTopCIFTestsPool3(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "c3DesktopCIFSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "c3DesktopCIFSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "c3DesktopCIFSuite");
...
//		task5.join();
	...
	public void executeDesktopRegistrationLegacyFormTestsPool1(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "a1DrlfSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "a1DrlfSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "a1DrlfSuite");
...
//		task5.join();
	...
	public void executeDesktopRegistrationLegacyFormTestsPool2(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "b2DrlfSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "b2DrlfSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "b2DrlfSuite");
...
//		task5.join();
	...
	public void executeDesktopIMAPTestsPool(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "imapSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "imapSuite");
		APIRunTask task2 = new APIRunTask(firefoxPath, "firefox", "imapSuite");
...
//		task5.join();
	...
	public void executeCollegeSearch(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "collegeSearchSuite");
...
//		task5.join();
	...
	public void executeMobileRegistrationLegacy(int number) {
		...
		APIRunTask task1 = new APIRunTask(androidChromePath,"androidchrome", "mobileRegistrationLegacyFormSuite");
	...
	public void executeMobileCif(int number) {
		...
		APIRunTask task1 = new APIRunTask(androidChromePath,"androidchrome", "mobileCifSuite");
	...
	public void executeMobileImap(int number) {
		...
		APIRunTask task1 = new APIRunTask(androidChromePath,"androidchrome", "mobileImapSuite");
	...
	public void executeIosSafariMobileRegistrationLegacy(int number) {
		System.out.println();
		ForkJoinPool mobileRegistratiionLegacy = new ForkJoinPool(number);
		APIRunTask task1 = new APIRunTask(iosSafariPath,"iossafari", "mobileRegistrationLegacyFormSuite");
		mobileRegistratiionLegacy.execute(task1);
		task1.join();
	}
	...
	public void executeIosSafariMobileCif(int number) {
		System.out.println();
		ForkJoinPool mobileCif = new ForkJoinPool(number);
		APIRunTask task1 = new APIRunTask(iosSafariPath,"iossafari", "mobileCifSuite");
		mobileCif.execute(task1);
		task1.join();
	}
	...
	public void executeIosSafariMobileImap(int number) {
		System.out.println();
		ForkJoinPool mobileImap = new ForkJoinPool(number);
		APIRunTask task1 = new APIRunTask(iosSafariPath,"iossafari", "mobileImapSuite");
		mobileImap.execute(task1);
		task1.join();
	}
	...
	public void executeApiAnalyticsJMeter(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "apiAnalyticsSuite");
	...
	public void executeTryItOut(int number) {
		...
		APIRunTask task1 = new APIRunTask(localPath,"localchrome", "tryItOut");
