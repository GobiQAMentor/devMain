...
public class LocalChromeRunTaskTemp extends RecursiveAction{
	...
	LocalChromeRunTaskTemp(String browserName, String testSuite){
		this.browserName = browserName;
		this.testSuite = testSuite;
	}

	LocalChromeRunTaskTemp(String path, String browserName, String testSuite){
		this.path = path;
		this.browserName = browserName;
		this.testSuite = testSuite;
	}

	LocalChromeRunTaskTemp(){
	...
	public static void main(String[] args) throws Exception {
		...
		LocalChromeRunTaskTemp task =new LocalChromeRunTaskTemp();
...
*/
	...
	public void executeAapTestsPool(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "aapSuite1");
...
//		task5.join();
	...
	public void executeAapTestsPool2(int number) {
		System.out.println();
		ForkJoinPool aapPool = new ForkJoinPool(number);
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "aapSuite2");
...
//		LocalChromeRunTaskTemp embedTask2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "embedSuite");
...
//		embedTask5.join();
	...
	public void executeExperience360TestsPool(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "exp360Suite");
...
//		task5.join();
	...
	public void executeIWCCFormerSuperContentTestsPool(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "iwcFormerSuperContentSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "iwcFormerSuperContentSuite");
//		LocalChromeRunTaskTemp task2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "iwcFormerSuperContentSuite");
...
//		task5.join();
	...
	public void executeSuperContentTestsPool(int number) {
		...
		LocalChromeRunTaskTemp superContentTask1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "supercontentSuite");
//		RunTaskTemp superContentTask1 = new RunTaskTemp(winchromePath,"winchrome", "supercontentSuite");
//		LocalChromeRunTaskTemp superContentTask2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "supercontentSuite");
...
//		superContentTask5.join();
	...
	public void executeDeskTopCIFTestsPool1(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "a1DesktopCIFSuite");
...
//		task5.join();
	...
	public void executeDeskTopCIFTestsPool2(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "b2DesktopCIFSuite");
...
//		task5.join();
	...
	public void executeDeskTopCIFTestsPool3(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "c3DesktopCIFSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "c3DesktopCIFSuite");
//		LocalChromeRunTaskTemp task2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "c3DesktopCIFSuite");
...
//		task5.join();
	...
	public void executeDesktopRegistrationLegacyFormTestsPool1(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "a1DrlfSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "a1DrlfSuite");
//		LocalChromeRunTaskTemp task2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "a1DrlfSuite");
...
//		task5.join();
	...
	public void executeDesktopRegistrationLegacyFormTestsPool2(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "b2DrlfSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "b2DrlfSuite");
//		LocalChromeRunTaskTemp task2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "b2DrlfSuite");
...
//		task5.join();
	...
	public void executeDesktopIMAPTestsPool(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "imapSuite");
//		RunTaskTemp task1 = new RunTaskTemp(winchromePath,"winchrome", "imapSuite");
//		LocalChromeRunTaskTemp task2 = new LocalChromeRunTaskTemp(firefoxPath, "firefox", "imapSuite");
...
//		task5.join();
	...
	public void executeCollegeSearch(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "collegeSearchSuite");
...
//		task5.join();
	...
	public void executeMobileRegistrationLegacy(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(androidChromePath,"androidchrome", "mobileRegistrationLegacyFormSuite");
	...
	public void executeMobileCif(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(androidChromePath,"androidchrome", "mobileCifSuite");
	...
	public void executeMobileImap(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(androidChromePath,"androidchrome", "mobileImapSuite");
	...
	public void executeIosSafariMobileRegistrationLegacy(int number) {
		System.out.println();
		ForkJoinPool mobileRegistratiionLegacy = new ForkJoinPool(number);
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(iosSafariPath,"iossafari", "mobileRegistrationLegacyFormSuite");
		mobileRegistratiionLegacy.execute(task1);
		task1.join();
	}
	...
	public void executeIosSafariMobileCif(int number) {
		System.out.println();
		ForkJoinPool mobileCif = new ForkJoinPool(number);
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(iosSafariPath,"iossafari", "mobileCifSuite");
		mobileCif.execute(task1);
		task1.join();
	}
	...
	public void executeIosSafariMobileImap(int number) {
		System.out.println();
		ForkJoinPool mobileImap = new ForkJoinPool(number);
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(iosSafariPath,"iossafari", "mobileImapSuite");
		mobileImap.execute(task1);
		task1.join();
	}
	...
	public void executeApiAnalyticsJMeter(int number) {
		...
		LocalChromeRunTaskTemp task1 = new LocalChromeRunTaskTemp(localPath,"localchrome", "apiAnalyticsSuite");
