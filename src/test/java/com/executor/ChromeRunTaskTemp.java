...
//		task5.join();
	...
	public void executeCollegeSearch(int number) {
		System.out.println();
		ForkJoinPool collegeSearchPool = new ForkJoinPool(number);
		ChromeRunTaskTemp task1 = new ChromeRunTaskTemp(localPath,"localchrome", "collegeSearchSuite");
//		ChromeRunTaskTemp task1 = new ChromeRunTaskTemp(winchromePath,"winchrome", "collegeSearchSuite");
//		ChromeRunTaskTemp task2 = new ChromeRunTaskTemp(firefoxPath, "firefox", "collegeSearchSuite");
//		ChromeRunTaskTemp task3 = new ChromeRunTaskTemp(edgePath, "edge", "collegeSearchSuite");
//		ChromeRunTaskTemp task4 = new ChromeRunTaskTemp(macchromePath, "macchrome", "collegeSearchSuite");
//		ChromeRunTaskTemp task5 = new ChromeRunTaskTemp(safariPath, "safari", "collegeSearchSuite");
		collegeSearchPool.execute(task1);
//		drlfPool.execute(task2);
//		drlfPool.execute(task3);
//		drlfPool.execute(task4);
//		drlfPool.execute(task5);
